...
public class chatapp extends AppCompatActivity {
    ...
    String uid,famuid,message,timestampp,chatuid,name;
    EditText addmessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatrecycler.setLayoutManager(new LinearLayoutManager(chatapp.this));
        chatlist.clear();
        namelist.clear();
        timestamplist.clear();
        ...
        usersRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                    chatobj chatobj = postSnapshot.getValue(chatobj.class);
                    ...
                    databasereff.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            layout = new LinearLayoutManager(chatapp.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(chatapp.this,Main2Activity.class));
    }
}
